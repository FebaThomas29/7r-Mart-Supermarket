...
public class LoginTest extends BaseClass {
	...
	@Test(groups = {
			"smoke" }, description = "User Login With Valid Username and InValid Password", priority = 3, dataProvider = "loginProvider")
	...
	public Object[][] getDataFromDataProvider() throws IOException {
		return new Object[][] { new Object[] { "admin12345", "admin34567" }, new Object[] { "admin", "admin234" },
